...
const infoList = [
  ...
  },
  {
    ...
    desc: '<div class="desc-title"><span class="highlight">“이 꽃 너한테 어울릴 것 같아”</span></div><div class="desc-text">풀멍은 반려식물 스투키와 숲 속에서<br>여유롭게 멍 때리는 것을 좋아해<br>가끔씩 친구들에게 꽃 한 송이를<br>선물해주기도 해</div><div class="desc-text-highlight">#꽃을든멍  #긍정파워  #풀내음</div><div class="desc-title"><span class="highlight">풀멍</span> 때리는 사람들은</div><div class="desc-text">⏰ 여유를 즐기며 휴식하기 위해 멍을 때려<br>💛 편안해지고 차분해지는 느낌을 받아<br>😶 모든 감감을 많이 활용해서 멍을 때려</div><div class="desc-title"><span class="highlight">풀멍</span> 추천 방법</div><div class="desc-text">숲  나무  잔디  반려식물</div><div class="desc-title"><span class="highlight">풀멍</span>과 유사한 유형</div><div class="desc-others-wrap"><div class="desc-others"><div class="others-img"><img src="../img/light_2d.png" alt="img/png"></div><div class="desc-text">빛멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/fire_2d.png" alt="img/png"></div><div class="desc-text">불멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/sky_2d.png" alt="img/png"></div><div class="desc-text">하늘멍</div></div></div><div class="result-qr">QR</div><div class="qr-desc">인스타그램에서해봐</div>'
  }
]
