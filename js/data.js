...
const infoList = [
  ...
  },
  {
    ...
    desc: '<div class="desc-text">- 불을 끄고 은은한 무드등을 보며 멍때려봐<br>- 밝은 조명이 비추는 곳을 가만히 바라봐<br>- 창문으로 들어오는 따뜻한 햇빛을 느껴봐<br>- 랜턴에 비춰진 작은 먼지를 찾아봐</div><div class="desc-title"><span class="highlight">빛멍</span>과 유사한 유형</div><div class="desc-others-wrap"><div class="desc-others"><div class="others-img"><img src="../img/plant_2d.png" alt="img/png"></div><div class="desc-text">풀멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/smoke_2d.png" alt="img/png"></div><div class="desc-text">연기멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/wall_2d.png" alt="img/png"></div><div class="desc-text">벽멍</div></div></div><div class="result-qr">QR</div><div class="qr-desc">인스타그램에서해봐</div>'
  },
  {
    ...
    desc: '<div class="desc-text">- 숲 속을 걸으며 자연의 향기를 맡아봐<br>- 손바닥으로 나무를 만져보며 결을 느껴봐<br>- 바람에 흔들리는 잔디를 보며 멍때려봐<br>- 반려식물을 사랑스럽게 바라봐</div><div class="desc-title"><span class="highlight">풀멍</span>과 유사한 유형</div><div class="desc-others-wrap"><div class="desc-others"><div class="others-img"><img src="../img/light_2d.png" alt="img/png"></div><div class="desc-text">빛멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/fire_2d.png" alt="img/png"></div><div class="desc-text">불멍</div></div><div class="desc-others"><div class="others-img"><img src="../img/sky_2d.png" alt="img/png"></div><div class="desc-text">하늘멍</div></div></div><div class="result-qr">QR</div><div class="qr-desc">인스타그램에서해봐</div>'
  }
]
