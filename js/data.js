...
const infoList = [
  ...
  },
  {
    ...
    story: '<div class="desc-title"><span class="highlight">“우와! 강아지 구름이야!”</span></div><div class="desc-text">하늘멍은 폭신한 몸과 넓은 마음을 가졌어. 항상 달콤한 솜사탕을 들고 다니는데 위로가 필요한 친구와 나눠먹으며 흘러가는 구름을 보는 것이 취미야.</div><div class="desc-text-highlight">#고민상담  #푸근한  #솜사탕</div><div class="desc-title"><span class="highlight">하늘멍</span> 때리는 사람들은</div><div class="desc-text">⏰ 지친 상태를 벗어나기 위해 멍을 때려<br>💛 편안함과 위로를 얻지<br>😶 시각, 청각, 후각에 집중해서 멍을 때려</div><div class="desc-title"><span class="highlight">하늘멍</span> 추천 방법</div>',
